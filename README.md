...
- 🔨 Pushed to [**obs-vkcapture**](https://github.com/anthonymendez/obs-vkcapture)
...
- 💬 Commented in [**nowrep/obs-vkcapture**](https://github.com/nowrep/obs-vkcapture)
- 💬 Commented in [**JonathanTreffler/backblaze-personal-wine-container**](https://github.com/JonathanTreffler/backblaze-personal-wine-container)
...
- ⭐ [**nekename/OpenDeck**](https://github.com/nekename/OpenDeck) (1918 ★) — Linux software for the Stream Deck with support for original Elgato Stream Deck plugins
- ⭐ [**Hkshoonya/nvidia-broadcast-linux**](https://github.com/Hkshoonya/nvidia-broadcast-linux) (81 ★) — NV Broadcast — Unofficial NVIDIA Broadcast for Linux and other OS. AI-powered virtual camera with background removal, blur, replacement, video enhancement, and noise cancellation. GPU accelerated. Open source.
- ⭐ [**samuelgursky/davinci-resolve-mcp**](https://github.com/samuelgursky/davinci-resolve-mcp) (1710 ★) — MCP server integration for DaVinci Resolve Studio
- ⭐ [**Adachi91/obs-multistream-libre**](https://github.com/Adachi91/obs-multistream-libre) (2 ★) — Ad-Removed OBS multi-streaming plugin.
- ⭐ [**veritus-git/BadWords**](https://github.com/veritus-git/BadWords) (14 ★) — better text-based editing inside DaVinci
...
- [⭐ 1 **Vector-Shot**](https://github.com/anthonymendez/Vector-Shot) — Submission for "Summer of Fast-to-Complete Games" Game Jam.
