...
- ⭐ [**srwi/EverythingToolbar**](https://github.com/srwi/EverythingToolbar) (14761 ★) — Everything integration for the Windows taskbar.
- ⭐ [**nekename/OpenDeck**](https://github.com/nekename/OpenDeck) (2187 ★) — Linux software for the Stream Deck with support for original Elgato Stream Deck plugins
...
- ⭐ [**samuelgursky/davinci-resolve-mcp**](https://github.com/samuelgursky/davinci-resolve-mcp) (2906 ★) — MCP server integration for DaVinci Resolve Studio
